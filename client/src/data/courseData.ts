...
These five dimensions are not parallel tracks. They are a network — each in constant relationship with the others, each capable of creating drag or generating lift across the entire system. Understanding that network is what makes the framework genuinely useful rather than merely comprehensive.`,
        ...
        {
          id: "1.2",
          title: "The Alignment Audit: Where Are You Now?",
          duration: "25 min",
          teaching: `Before any system can be improved, it must be accurately assessed. The Alignment Audit is the honest look — the deliberate, specific examination of where each dimension currently stands, without the distortions of optimism, shame, or the tendency to conflate intention with reality.
