...
export const LUMIN_VIDEOS: LuminVideo[] = [
  ...
  },
  {
    ...
    action: "Calm self-embrace — clean Align daily-grounding scene supplied by the user",
    role: "landscape",
    duration: 8,
  },
  {
  ...
  },
  {
    ...
    action: "Radiant starburst and joyful expansion — clean Flow visualization scene supplied by the user",
    role: "landscape",
    duration: 8,
  },
  {
