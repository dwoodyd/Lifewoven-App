      ...
      <section className="py-32 bg-[oklch(0.10_0.015_260)]">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              { step: "01", title: "Take the Alignment Audit", desc: "A 12-question diagnostic. 5 minutes. Tells you exactly where to begin.", cta: "Begin the Audit", href: "/audit" },
            ...
            {[
              {
                ...
                features: ["Alignment Audit diagnostic", "Daily emotional check-in", "Journal (30 entries)", "Align & Uplift pathways", "5S Framework overview"],
                cta: "Start Free",
                href: "/audit",
                highlight: false,
              },
              {
                ...
                features: ["Everything in Explorer", "Unlimited journal entries", "All 7 pathways", "Full 5S module suite", "Habit tracker & scorecard", "Decision journal", "Energy audit & trends"],
              ...
              },
              {
                ...
                features: ["Everything in Seeker", "Unlimited Oracle AI chat", "AI journal reflections", "Cross-module pattern insights", "Monthly Oracle deep-dive report", "1-on-1 onboarding call"],
