...
const HOW_TO_STEPS = [
  { step: "01", icon: Compass, title: "Take the Load-Bearing Survey", desc: "A 12-question diagnostic that maps your current state across all 5 dimensions and recommends your first pathway. Takes 5 minutes. Starts everything.", cta: "Begin the survey", href: "/audit", termKey: "Load-Bearing Survey" },
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              <Link href="/audit">
                <Button className="gap-2">Take the Load-Bearing Survey <ArrowRight className="h-4 w-4" /></Button>
              </Link>
              <Link href="/dashboard">
              ...
              <div key={step} className="p-4 sm:p-6 rounded-2xl border border-border bg-card">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1.5 flex-wrap">
                      ...
                      {step === "01" ? <TermTooltip term="Load-Bearing Survey">{title}</TermTooltip>
      ...
      <section className="py-20 border-t border-border">
        <div className="container max-w-2xl mx-auto text-center">
          ...
          <p className="text-muted-foreground font-light mb-8">The Load-Bearing Survey takes 5 minutes and tells you exactly where to start.</p>
          <div className="flex flex-wrap justify-center gap-3">
            <Link href="/audit">
              <Button size="lg" className="gap-2">Take the Load-Bearing Survey <ArrowRight className="h-4 w-4" /></Button>
            </Link>
            <Link href="/pricing">
