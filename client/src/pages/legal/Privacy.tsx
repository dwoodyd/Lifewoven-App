      ...
      <div className="container pt-28 pb-20 max-w-3xl mx-auto">
        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed text-sm">Your data is used to: provide and improve the LifeOS platform, power AI features such as the Oracle and pattern recognition, send you relevant communications about your account and the platform, and analyze aggregate usage trends (never individual user data) to improve our products.</p>
          </section>
