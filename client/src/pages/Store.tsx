...
const PRODUCTS = [
  {
    ...
    price: "$97",
    description: "A 6-week immersive course that walks you through each of the 5S modules with daily practices, video lessons, and journaling exercises. Build the foundation of your LifeOS.",
      ...
      <div className="container pt-24 pb-20 max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground text-lg font-light max-w-xl mx-auto">
            Courses, workbooks, audio programs, and card decks — each one an original LifeOS creation, distilling timeless wisdom into practical tools for modern life.
          </p>
        </div>
        ...
        <div className="mt-16 p-8 rounded-2xl border border-border bg-card text-center">
          ...
          <p className="text-muted-foreground text-sm mb-6 max-w-md mx-auto">
            Get the complete LifeOS toolkit — all courses, workbooks, audio programs, and card decks — at one transformational price.
          </p>
        ...
        <p className="text-center text-xs text-muted-foreground mt-8 max-w-2xl mx-auto">
          All LifeOS courses, workbooks, and audio programs are original creations. They are informed by wisdom traditions and personal development ideas but are independently produced and not affiliated with, endorsed by, or licensed by any named author, teacher, or publisher.
        </p>
      </div>
    </div>
  );
