...
type ProductRow = {
  ...
  type: "course" | "workbook" | "card_deck" | "audio_bundle" | "script_bundle" | "planner" | "guide";
  price: string;
...
const PRODUCT_TYPES = ["course", "workbook", "card_deck", "audio_bundle", "script_bundle", "planner", "guide"] as const;
