      ...
      <div className="container pt-24 pb-20 max-w-3xl mx-auto">
        ...
        <div className="flex items-start gap-4 mb-10">
          ...
          <div>
            ...
            <h1 className="font-serif text-3xl md:text-4xl font-light text-foreground mb-2">Community</h1>
        ...
        {/* Waitlist card */}
        <div className="p-8 rounded-2xl border border-border bg-card mb-10 text-center">
