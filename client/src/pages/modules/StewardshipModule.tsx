        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-5 rounded-2xl border border-border bg-card"><div className="flex items-center gap-2 mb-4"><Sun className="h-4 w-4 text-orange-400" /><h2 className="font-serif text-base font-light text-foreground">Energy Sources</h2></div><div className="space-y-1.5">{ENERGY_SOURCES.map(s => <div key={s} className="flex items-center gap-2 text-xs text-foreground"><span className="text-stewardship">+</span>{s}</div>)}</div></div>
              <div className="p-5 rounded-2xl border border-border bg-card"><div className="flex items-center gap-2 mb-4"><Moon className="h-4 w-4 text-muted-foreground" /><h2 className="font-serif text-base font-light text-foreground">Energy Drains</h2></div><div className="space-y-1.5">{ENERGY_DRAINS.map(d => <div key={d} className="flex items-center gap-2 text-xs text-foreground"><span className="text-destructive">−</span>{d}</div>)}</div></div>
            </div>
            <div className="p-6 rounded-2xl border border-border bg-card">
