...
const RESOURCES: Resource[] = [
  {
    ...
    rights: "original",
    rightsNote: "Original Lifewoven interpretation of the Emotional Guidance Scale concept. Not a reproduction of copyrighted text.",
  },
  {
  ...
  },
  {
    ...
    type: "Guide", free: true,
    rights: "original",
    rightsNote: "Original Lifewoven content. Inspired by Abraham-Hicks principles, not a reproduction of copyrighted text.",
  },
  {
    id: 5, category: "audio", module: "state",
    title: "Getting Into the Vortex — Guided Practice",
    author: "Lifewoven",
    description: "An original Lifewoven guided meditation for entering a state of vibrational alignment, inspired by the Vortex concept from Abraham-Hicks teachings.",
  ...
  },
  {
    ...
    rights: "original",
    rightsNote: "Original Lifewoven content. Inspired by Summer McStravick's Flowdreaming concept. Not a reproduction of copyrighted text.",
  },
  {
...
const RIGHTS_CONFIG: Record<RightsLabel, { label: string; color: string; bg: string; description: string }> = {
  ...
  "original": {
    ...
    description: "Original content created by Lifewoven, inspired by transformational teachings.",
  },
  "licensed": {
    label: "Licensed",
    color: "text-blue-700",
