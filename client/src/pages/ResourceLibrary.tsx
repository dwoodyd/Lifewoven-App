...
const RESOURCES: Resource[] = [
  {
    ...
    description: "The complete 22-level emotional scale from despair to joy, with original Steadora guidance on how to use it as your inner GPS for daily alignment.",
    type: "Guide", free: true,
    rights: "original",
    rightsNote: "Original Steadora interpretation of the Emotional Guidance Scale concept. Not a reproduction of copyrighted text.",
  },
  {
    id: 2, category: "text", module: "story",
    title: "Creative Mind and Success",
    author: "Ernest Holmes",
    description: "Holmes' foundational work on the power of thought to create material reality. Published 1919. Available in full as a verified public domain text.",
    type: "Book", free: true,
    rights: "public-domain",
    rightsNote: "Published 1919. US copyright expired. Verified public domain.",
  },
  {
    id: 3, category: "text", module: "stewardship",
    title: "Living the Science of Mind",
    author: "Ernest Holmes",
    description: "Daily readings and meditations from Holmes' Science of Mind teachings. A companion for daily practice.",
    type: "Book", free: true,
    rights: "public-domain",
  ...
  },
  {
    ...
    author: "Steadora (Inspired by Abraham-Hicks)",
    description: "22 original Steadora practices for shifting your emotional baseline upward, inspired by the Abraham-Hicks teachings but written as original platform content.",
    type: "Guide", free: true,
    rights: "original",
    rightsNote: "Original Steadora content. Inspired by Abraham-Hicks principles, not a reproduction of copyrighted text.",
  },
  {
    id: 5, category: "audio", module: "state",
    title: "Getting Into the Vortex — Guided Practice",
    author: "Steadora",
    description: "An original Steadora guided meditation for entering a state of vibrational alignment, inspired by the Vortex concept from Abraham-Hicks teachings.",
    type: "Meditation", free: false,
    rights: "original",
    rightsNote: "Original Steadora audio content. Inspired by Abraham-Hicks concepts, not a reproduction of any copyrighted recording.",
  },
  {
    id: 6, category: "text", module: "standards",
    title: "The Four Laws of Behavior Change — Framework Summary",
    author: "Steadora (Inspired by James Clear)",
    description: "An original Steadora summary of the habit loop framework: Make It Obvious, Attractive, Easy, and Satisfying — with original application exercises.",
    type: "Summary", free: true,
    rights: "original",
    rightsNote: "Original Steadora content. Inspired by Atomic Habits principles. Not a reproduction of James Clear's copyrighted text.",
  },
  {
    id: 7, category: "text", module: "story",
    title: "Finding Meaning — A Logotherapy Primer",
    author: "Steadora (Inspired by Viktor Frankl)",
    description: "An original Steadora exploration of meaning-centered living, inspired by Frankl's logotherapy. Includes original reflection exercises.",
    type: "Summary", free: true,
    rights: "original",
    rightsNote: "Original Steadora content. Inspired by Viktor Frankl's philosophy. Not a reproduction of Man's Search for Meaning.",
  },
  {
    id: 8, category: "text", module: "state",
    title: "The Art of Allowing — Principles Guide",
    author: "Steadora",
    description: "An original Steadora guide to the third element of deliberate creation: releasing resistance and allowing desires to manifest.",
    type: "Guide", free: false,
    rights: "original",
    rightsNote: "Original Steadora content.",
  },
  {
    ...
    rights: "original",
    rightsNote: "Original Steadora audio content.",
  },
  {
  ...
  },
  {
    ...
    author: "Steadora (Inspired by Summer McStravick)",
    description: "An original Steadora introduction to Flowdreaming — the practice of manifesting through emotional immersion in desired futures.",
    type: "Overview", free: true,
    rights: "original",
    rightsNote: "Original Steadora content. Inspired by Summer McStravick's Flowdreaming concept. Not a reproduction of copyrighted text.",
  },
  {
    id: 12, category: "audio", module: "story",
    title: "Belief Rewrite Meditation",
    author: "Steadora",
    description: "A guided audio session for identifying and rewriting a core limiting belief using the Story module framework.",
    type: "Meditation", free: false,
    rights: "original",
    rightsNote: "Original Steadora audio content.",
  },
...
const RIGHTS_CONFIG: Record<RightsLabel, { label: string; color: string; bg: string; description: string }> = {
  ...
  "original": {
    label: "Original Steadora",
    color: "text-accent",
    bg: "bg-accent/5 border-accent/20",
    description: "Original content created by Steadora, inspired by transformational teachings.",
  },
  "licensed": {
    label: "Licensed",
    color: "text-blue-700",
