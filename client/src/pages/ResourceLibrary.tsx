...
const RESOURCES: Resource[] = [
  {
    ...
    description: "The complete 22-level emotional scale from despair to joy, with original LifeOS guidance on how to use it as your inner GPS for daily alignment.",
    type: "Guide", free: true,
    rights: "original",
    rightsNote: "Original LifeOS interpretation of the Emotional Guidance Scale concept. Not a reproduction of copyrighted text.",
  },
  {
  ...
  },
  {
    ...
    author: "LifeOS (Inspired by Abraham-Hicks)",
    description: "22 original LifeOS practices for shifting your emotional baseline upward, inspired by the Abraham-Hicks teachings but written as original platform content.",
    type: "Guide", free: true,
    rights: "original",
    rightsNote: "Original LifeOS content. Inspired by Abraham-Hicks principles, not a reproduction of copyrighted text.",
  },
  {
    id: 5, category: "audio", module: "state",
    title: "Getting Into the Vortex — Guided Practice",
    author: "LifeOS",
    description: "An original LifeOS guided meditation for entering a state of vibrational alignment, inspired by the Vortex concept from Abraham-Hicks teachings.",
    type: "Meditation", free: false,
    rights: "original",
    rightsNote: "Original LifeOS audio content. Inspired by Abraham-Hicks concepts, not a reproduction of any copyrighted recording.",
  },
  {
    id: 6, category: "text", module: "standards",
    title: "The Four Laws of Behavior Change — Framework Summary",
    author: "LifeOS (Inspired by James Clear)",
    description: "An original LifeOS summary of the habit loop framework: Make It Obvious, Attractive, Easy, and Satisfying — with original application exercises.",
    type: "Summary", free: true,
    rights: "original",
    rightsNote: "Original LifeOS content. Inspired by Atomic Habits principles. Not a reproduction of James Clear's copyrighted text.",
  },
  {
    id: 7, category: "text", module: "story",
    title: "Finding Meaning — A Logotherapy Primer",
    author: "LifeOS (Inspired by Viktor Frankl)",
    description: "An original LifeOS exploration of meaning-centered living, inspired by Frankl's logotherapy. Includes original reflection exercises.",
    type: "Summary", free: true,
    rights: "original",
    rightsNote: "Original LifeOS content. Inspired by Viktor Frankl's philosophy. Not a reproduction of Man's Search for Meaning.",
  },
  {
    id: 8, category: "text", module: "state",
    title: "The Art of Allowing — Principles Guide",
    author: "LifeOS",
    description: "An original LifeOS guide to the third element of deliberate creation: releasing resistance and allowing desires to manifest.",
    type: "Guide", free: false,
    rights: "original",
    rightsNote: "Original LifeOS content.",
  },
  {
    ...
    rights: "original",
    rightsNote: "Original LifeOS audio content.",
  },
  {
  ...
  },
  {
    ...
    author: "LifeOS (Inspired by Summer McStravick)",
    description: "An original LifeOS introduction to Flowdreaming — the practice of manifesting through emotional immersion in desired futures.",
    type: "Overview", free: true,
    rights: "original",
    rightsNote: "Original LifeOS content. Inspired by Summer McStravick's Flowdreaming concept. Not a reproduction of copyrighted text.",
  },
  {
...
const RIGHTS_CONFIG: Record<RightsLabel, { label: string; color: string; bg: string; description: string }> = {
  ...
  "original": {
    label: "Original LifeOS",
    color: "text-accent",
    bg: "bg-accent/5 border-accent/20",
    description: "Original content created by LifeOS, inspired by transformational teachings.",
  },
  "licensed": {
    label: "Licensed",
    color: "text-blue-700",
