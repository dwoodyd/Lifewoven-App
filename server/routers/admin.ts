...
export const adminRouter = router({
  ...
  createProduct: adminProcedure
    .input(z.object({
      ...
      type: z.enum(["course", "workbook", "card_deck", "audio_bundle", "script_bundle", "planner", "guide"]),
  ...
  updateProduct: adminProcedure
    .input(z.object({
      ...
      description: z.string().optional(),
      type: z.enum(["course", "workbook", "card_deck", "audio_bundle", "script_bundle", "planner", "guide"]).optional(),
